...
public class fragment_kynang_nghethuatsong extends Fragment implements InterfaceLoadMore {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kynang_nghethuatsong, container, false);
        layoutMain = view.findViewById(R.id.layoutMainKyNangNgheThuatSong);
            ...
            tvKetNoiInterNet.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!connectInternet.checkInternetConnection()) {
                        ...
                        View viewHaveInternet = inflater.inflate(R.layout.layout_fragment_kynang_nghethuatsong, container, false);
    ...
    private void initView(View view) {
        ...
        recyclerView = view.findViewById(R.id.recyclerViewKyNangNgheThuatSong);
            ...
            try {
                threadPoolExecutor.execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        viewBook = modelMain.getListSachByCatelogy1(SaveVariables.maKyNangNgheThuatSong, 0);
                        viewModelMain.getViewListKyNangNgheThuatSong().postValue(viewBook);
                        handler1.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                if (viewBook.getListSach().size() > 0) {
                                    progressBarHead.setVisibility(View.GONE);
                                    countSum = viewModelMain.getViewListKyNangNgheThuatSong().getValue().getTotalNumberSach();
                                    adapter = new CustomAdapterRecyelerView_Main(getActivity(), R.layout.custom_row_recyclerview_main,
                                            viewModelMain.getViewListKyNangNgheThuatSong().getValue().getListSach());
                                    ...
                                    loadMore = new LoadMore(layoutManager, fragment_kynang_nghethuatsong.this);
                ...
                Log.d("AAA", "Thread fragment_kynang_nghethuatsong loi");
            }
    ...
    public void xuLyLoadMore(int totalItem) {
        if (connectInternet.checkInternetConnection()) {
            ...
            sum = totalItem;
            tong = viewModelMain.getViewListKyNangNgheThuatSong().getValue().getListSach().size();
            if (tong < countSum) {
                ...
                try {
                    threadPoolExecutor.execute(new Runnable() {
                        @Override
                        public void run() {
                            viewModelMain.getViewListKyNangNgheThuatSong().getValue()
                                    .getListSach()
                                    .addAll(modelMain.getListSachByCatelogy1(SaveVariables.maKyNangNgheThuatSong, sum).getListSach());
                    ...
                    e.printStackTrace();
                    Thread.currentThread().interrupt();
                    Log.d("AAA", "Thread LoadMore fragment_kynang_nghethuatsong loi");
                }
    ...
    Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            if (viewModelMain.getViewListKyNangNgheThuatSong().getValue().getListSach().size() != tong) {
                progressBar.setVisibility(View.GONE);
                if (viewModelMain.getViewListKyNangNgheThuatSong().getValue().getListSach().size() < countSum) {
